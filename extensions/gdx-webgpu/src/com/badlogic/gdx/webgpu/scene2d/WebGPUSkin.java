...
import com.badlogic.gdx.webgpu.graphics.g2d.WebGPUTextureAtlas;
 ...
 * @author Nathan Sweet */
public class WebGPUSkin extends Skin {
	...
	public WebGPUSkin(FileHandle skinFile) {
		FileHandle atlasFile = skinFile.sibling(skinFile.nameWithoutExtension() + ".atlas");
		if (atlasFile.exists()) {
			atlas = new WebGPUTextureAtlas(atlasFile);
			addRegions(atlas);
		}
	...
	public WebGPUSkin(FileHandle skinFile, TextureAtlas atlas) {
		this.atlas = atlas;
		addRegions(atlas);
		load(skinFile);
	}
	 ...
	 * is disposed. */
	public WebGPUSkin(TextureAtlas atlas) {
		this.atlas = atlas;
		addRegions(atlas);
	}
	...
	public void load (FileHandle skinFile) {
		try {
			getJsonLoader(skinFile).fromJson(WebGPUSkin.class, skinFile);
	...
	protected Json getJsonLoader (final FileHandle skinFile) {
		...
		json.setSerializer(WebGPUSkin.class, new ReadOnlySerializer<WebGPUSkin>() {
			public WebGPUSkin read (Json json, JsonValue typeToValueMap, Class ignored) {
