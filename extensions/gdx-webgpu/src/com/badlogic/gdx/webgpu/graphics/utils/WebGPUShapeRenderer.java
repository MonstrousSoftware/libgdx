...
public class WebGPUShapeRenderer implements Disposable {
	...
	public WebGPUShapeRenderer(int maxVertices) {
		this(maxVertices, null);
	}

	public WebGPUShapeRenderer(int maxVertices, ShaderProgram defaultShader) {
		if (defaultShader == null) {
			renderer = new WebGPUImmediateModeRenderer(maxVertices, false, true, 0);
		} else {
