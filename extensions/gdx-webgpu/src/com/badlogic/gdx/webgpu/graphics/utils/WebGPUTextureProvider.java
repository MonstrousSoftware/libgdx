 ...
 *
 */
public interface WebGPUTextureProvider extends TextureProvider {
	public Texture load (String fileName);

	public static class FileTextureProvider implements WebGPUTextureProvider {
		...
		@Override
		public Texture load (String fileName) {
			Texture result = new WebGPUTexture(Gdx.files.internal(fileName), useMipMaps);
