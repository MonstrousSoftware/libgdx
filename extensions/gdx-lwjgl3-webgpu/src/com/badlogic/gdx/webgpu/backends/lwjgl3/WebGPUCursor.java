...
public class WebGPUCursor implements Cursor {
	static final Array<WebGPUCursor> cursors = new Array<WebGPUCursor>();
	...
	static void dispose (WebGPUWindow window) {
		for (int i = cursors.size - 1; i >= 0; i--) {
			WebGPUCursor cursor = cursors.get(i);
