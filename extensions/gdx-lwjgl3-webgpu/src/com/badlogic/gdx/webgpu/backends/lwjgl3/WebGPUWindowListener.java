 ...
 * set per window via {@link WebGPUApplicationConfiguration} and {@link WebGPUWindowConfiguration}. Close events can be canceled
 * by returning false.
 * 
 * @author badlogic */
public interface WebGPUWindowListener {

	/** Called after the GLFW window is created. Before this callback is received, it's unsafe to use any {@link WebGPUWindow}
	 ...
	 * {@link WebGPUApplication#WebGPUApplication(ApplicationListener, WebGPUApplicationConfiguration)}.
	 *
	 * @param window the window instance
	 *
	 * @see WebGPUApplication#newWindow(ApplicationListener, WebGPUWindowConfiguration) */
	void created (WebGPUWindow window);
	 ...
	 * {@link WebGPUGraphics#requestRendering()} is automatically called. */
