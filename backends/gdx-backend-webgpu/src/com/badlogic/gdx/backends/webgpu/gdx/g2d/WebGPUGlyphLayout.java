...
public class WebGPUGlyphLayout implements Poolable {
	...
	public WebGPUGlyphLayout() {
	}

	/** @see #setText(BitmapFont, CharSequence) */
	public WebGPUGlyphLayout(WebGPUBitmapFont font, CharSequence str) {
		setText(font, str);
	}

	/** @see #setText(BitmapFont, CharSequence) */
	public WebGPUGlyphLayout(WebGPUBitmapFont font, CharSequence str, Color color, float targetWidth, int halign, boolean wrap) {
		setText(font, str, color, targetWidth, halign, wrap);
	}

	/** @see #setText(BitmapFont, CharSequence) */
	public WebGPUGlyphLayout(WebGPUBitmapFont font, CharSequence str, int start, int end, Color color, float targetWidth, int halign,
                             boolean wrap, String truncate) {
		setText(font, str, start, end, color, targetWidth, halign, wrap, truncate);
	}

	/** Calls {@link #setText(WebGPUBitmapFont, CharSequence, int, int, Color, float, int, boolean, String) setText} with the whole
	 * string, the font's current color, and no alignment or wrapping. */
	public void setText (WebGPUBitmapFont font, CharSequence str) {
		setText(font, str, 0, str.length(), font.getColor(), 0, Align.left, false, null);
	}

	/** Calls {@link #setText(WebGPUBitmapFont, CharSequence, int, int, Color, float, int, boolean, String) setText} with the whole
	 * string and no truncation. */
	public void setText (WebGPUBitmapFont font, CharSequence str, Color color, float targetWidth, int halign, boolean wrap) {
	...
	public void setText (WebGPUBitmapFont font, CharSequence str, int start, int end, Color color, float targetWidth, int halign,
		boolean wrap, @Null String truncate) {

		reset();

		WebGPUBitmapFont.BitmapFontData fontData = font.data;
	...
	private void calculateWidths (WebGPUBitmapFont.BitmapFontData fontData) {
		float width = 0;
	...
	private void truncate (WebGPUBitmapFont.BitmapFontData fontData, GlyphRun run, float targetWidth, String truncate) {
	...
	private GlyphRun wrap (WebGPUBitmapFont.BitmapFontData fontData, GlyphRun first, int wrapIndex) {
	...
	private void setLastGlyphXAdvance (WebGPUBitmapFont.BitmapFontData fontData, GlyphRun run) {
	...
	private float getGlyphWidth (Glyph glyph, WebGPUBitmapFont.BitmapFontData fontData) {
	...
	private float getLineOffset (Array<Glyph> glyphs, WebGPUBitmapFont.BitmapFontData fontData) {
