...
public class WebGPUBitmapFontCache {
	static private final Color tempColor = new Color(1, 1, 1, 1);

	private final WebGPUBitmapFont font;
	private boolean integer;
	private final Array<WebGPUGlyphLayout> layouts = new Array(1);
	private final Array<WebGPUGlyphLayout> pooledLayouts = new Array(0);
	...
	public WebGPUBitmapFontCache(WebGPUBitmapFont font) {
		this(font, font.usesIntegerPositions());
	}

	/** @param integer If true, rendering positions will be at integer values to avoid filtering artifacts. */
	public WebGPUBitmapFontCache(WebGPUBitmapFont font, boolean integer) {
		this.font = font;
	...
	public void tint (Color tint) {
		...
		for (int i = 0, n = layouts.size; i < n; i++) {
			...
			for (int ii = 0, nn = layout.runs.size; ii < nn; ii++) {
				WebGPUGlyphLayout.GlyphRun run = layout.runs.get(ii);
	...
	private void requireGlyphs (WebGPUGlyphLayout layout) {
	...
	private void addToCache (WebGPUGlyphLayout layout, float x, float y) {
		...
		for (int i = 0; i < runCount; i++) {
			WebGPUGlyphLayout.GlyphRun run = layout.runs.get(i);
			Object[] glyphs = run.glyphs.items;
	...
	public WebGPUGlyphLayout setText (CharSequence str, float x, float y) {
		clear();
	...
	/** Clears any cached glyphs and adds glyphs for the specified text.
	 * @see #addText(CharSequence, float, float, int, int, float, int, boolean, String) */
	public WebGPUGlyphLayout setText (CharSequence str, float x, float y, float targetWidth, int halign, boolean wrap) {
		clear();
	...
	/** Clears any cached glyphs and adds glyphs for the specified text.
	 * @see #addText(CharSequence, float, float, int, int, float, int, boolean, String) */
	public WebGPUGlyphLayout setText (CharSequence str, float x, float y, int start, int end, float targetWidth, int halign,
		boolean wrap) {
		clear();
	 ...
	 * @see #addText(CharSequence, float, float, int, int, float, int, boolean, String) */
	public void setText (WebGPUGlyphLayout layout, float x, float y) {
		clear();
		addText(layout, x, y);
	}
	 ...
	 * @see #addText(CharSequence, float, float, int, int, float, int, boolean, String) */
	public WebGPUGlyphLayout addText (CharSequence str, float x, float y) {
		return addText(str, x, y, 0, str.length(), 0, Align.left, false, null);
	}

	/** Adds glyphs for the specified text.
	 * @see #addText(CharSequence, float, float, int, int, float, int, boolean, String) */
	public WebGPUGlyphLayout addText (CharSequence str, float x, float y, float targetWidth, int halign, boolean wrap) {
		return addText(str, x, y, 0, str.length(), targetWidth, halign, wrap, null);
	}

	/** Adds glyphs for the specified text.
	 * @see #addText(CharSequence, float, float, int, int, float, int, boolean, String) */
	public WebGPUGlyphLayout addText (CharSequence str, float x, float y, int start, int end, float targetWidth, int halign,
		boolean wrap) {
	...
	public WebGPUGlyphLayout addText (CharSequence str, float x, float y, int start, int end, float targetWidth, int halign,
		boolean wrap, String truncate) {
		WebGPUGlyphLayout layout = Pools.obtain(WebGPUGlyphLayout::new);
	...
	public void addText (WebGPUGlyphLayout layout, float x, float y) {
	...
	public WebGPUBitmapFont getFont () {
		return font;
	}
	...
	public Array<WebGPUGlyphLayout> getLayouts () {
		return layouts;
	}
}
