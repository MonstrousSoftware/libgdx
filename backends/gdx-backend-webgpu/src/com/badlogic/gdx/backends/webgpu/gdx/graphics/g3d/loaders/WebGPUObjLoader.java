 ...
 *
 */
public class WebGPUObjLoader extends WebGPUModelLoader<WebGPUObjLoader.ObjLoaderParameters> {
	...
	public WebGPUObjLoader () {
		this(null);
	}

	public WebGPUObjLoader (FileHandleResolver resolver) {
		super(resolver);
	}
